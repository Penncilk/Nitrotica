...
HX_LOCAL_STACK_FRAME(_hx_pos_c253aa5a96d752cf_167_charCodeAt,"_UnicodeString.UnicodeString_Impl_","charCodeAt",0xd9768435,"_UnicodeString.UnicodeString_Impl_.charCodeAt","/home/judeu/haxe/versions/4.1.5/std/UnicodeString.hx",167,0x26689ebf)
HX_LOCAL_STACK_FRAME(_hx_pos_c253aa5a96d752cf_315_substr,"_UnicodeString.UnicodeString_Impl_","substr",0xd1a740f0,"_UnicodeString.UnicodeString_Impl_.substr","/home/judeu/haxe/versions/4.1.5/std/UnicodeString.hx",315,0x26689ebf)
HX_LOCAL_STACK_FRAME(_hx_pos_c253aa5a96d752cf_415_get_length,"_UnicodeString.UnicodeString_Impl_","get_length",0x33b0a1ee,"_UnicodeString.UnicodeString_Impl_.get_length","/home/judeu/haxe/versions/4.1.5/std/UnicodeString.hx",415,0x26689ebf)
...
bool UnicodeString_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic UnicodeString_Impl__obj::charCodeAt(::String this1,int index){
            	HX_STACKFRAME(&_hx_pos_c253aa5a96d752cf_167_charCodeAt)
...
::String UnicodeString_Impl__obj::substr(::String this1,int pos, ::Dynamic len){
            	HX_STACKFRAME(&_hx_pos_c253aa5a96d752cf_315_substr)
HXLINE( 316)		if ((pos < 0)) {
...
int UnicodeString_Impl__obj::get_length(::String this1){
            	HX_STACKFRAME(&_hx_pos_c253aa5a96d752cf_415_get_length)
HXLINE( 416)		int l = 0;
HXLINE( 417)		{
