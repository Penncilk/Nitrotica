...
HX_DEFINE_STACK_FRAME(_hx_pos_934bd6f0ca678458_51_new,"haxe.format.JsonParser","new",0xa017eec8,"haxe.format.JsonParser.new","/home/judeu/haxe/versions/4.1.5/std/haxe/format/JsonParser.hx",51,0x0f16d8b9)
HX_LOCAL_STACK_FRAME(_hx_pos_934bd6f0ca678458_56_doParse,"haxe.format.JsonParser","doParse",0xa959e310,"haxe.format.JsonParser.doParse","/home/judeu/haxe/versions/4.1.5/std/haxe/format/JsonParser.hx",56,0x0f16d8b9)
HX_LOCAL_STACK_FRAME(_hx_pos_934bd6f0ca678458_71_parseRec,"haxe.format.JsonParser","parseRec",0xda258b75,"haxe.format.JsonParser.parseRec","/home/judeu/haxe/versions/4.1.5/std/haxe/format/JsonParser.hx",71,0x0f16d8b9)
HX_LOCAL_STACK_FRAME(_hx_pos_934bd6f0ca678458_152_parseString,"haxe.format.JsonParser","parseString",0x8c919bcc,"haxe.format.JsonParser.parseString","/home/judeu/haxe/versions/4.1.5/std/haxe/format/JsonParser.hx",152,0x0f16d8b9)
HX_LOCAL_STACK_FRAME(_hx_pos_934bd6f0ca678458_312_invalidChar,"haxe.format.JsonParser","invalidChar",0xa9f373d5,"haxe.format.JsonParser.invalidChar","/home/judeu/haxe/versions/4.1.5/std/haxe/format/JsonParser.hx",312,0x0f16d8b9)
HX_LOCAL_STACK_FRAME(_hx_pos_934bd6f0ca678458_318_invalidNumber,"haxe.format.JsonParser","invalidNumber",0x8e9d1988,"haxe.format.JsonParser.invalidNumber","/home/judeu/haxe/versions/4.1.5/std/haxe/format/JsonParser.hx",318,0x0f16d8b9)
namespace haxe{
namespace format{

void JsonParser_obj::__construct(::String str){
            	HX_STACKFRAME(&_hx_pos_934bd6f0ca678458_51_new)
...
bool JsonParser_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic JsonParser_obj::doParse(){
            	HX_STACKFRAME(&_hx_pos_934bd6f0ca678458_56_doParse)
...
HX_DEFINE_DYNAMIC_FUNC0(JsonParser_obj,doParse,return )
 ...
 ::Dynamic JsonParser_obj::parseRec(){
            	HX_STACKFRAME(&_hx_pos_934bd6f0ca678458_71_parseRec)
...
::String JsonParser_obj::parseString(){
            	HX_GC_STACKFRAME(&_hx_pos_934bd6f0ca678458_152_parseString)
...
void JsonParser_obj::invalidChar(){
            	HX_STACKFRAME(&_hx_pos_934bd6f0ca678458_312_invalidChar)
HXLINE( 313)		this->pos--;
...
void JsonParser_obj::invalidNumber(int start){
            	HX_STACKFRAME(&_hx_pos_934bd6f0ca678458_318_invalidNumber)
