...
HX_DEFINE_STACK_FRAME(_hx_pos_9a8f9ab533ed2fe7_32_new,"haxe.crypto.Adler32","new",0xc900c8e2,"haxe.crypto.Adler32.new","/home/judeu/haxe/versions/4.1.5/std/haxe/crypto/Adler32.hx",32,0x0998ed1d)
HX_LOCAL_STACK_FRAME(_hx_pos_9a8f9ab533ed2fe7_41_update,"haxe.crypto.Adler32","update",0xb4b14ac7,"haxe.crypto.Adler32.update","/home/judeu/haxe/versions/4.1.5/std/haxe/crypto/Adler32.hx",41,0x0998ed1d)
HX_LOCAL_STACK_FRAME(_hx_pos_9a8f9ab533ed2fe7_53_equals,"haxe.crypto.Adler32","equals",0xed9eb2fd,"haxe.crypto.Adler32.equals","/home/judeu/haxe/versions/4.1.5/std/haxe/crypto/Adler32.hx",53,0x0998ed1d)
HX_LOCAL_STACK_FRAME(_hx_pos_9a8f9ab533ed2fe7_60_read,"haxe.crypto.Adler32","read",0x1a53c494,"haxe.crypto.Adler32.read","/home/judeu/haxe/versions/4.1.5/std/haxe/crypto/Adler32.hx",60,0x0998ed1d)
namespace haxe{
namespace crypto{

void Adler32_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_9a8f9ab533ed2fe7_32_new)
HXLINE(  33)		this->a1 = 1;
HXLINE(  34)		this->a2 = 0;
            	}
...
void Adler32_obj::update( ::haxe::io::Bytes b,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_9a8f9ab533ed2fe7_41_update)
...
bool Adler32_obj::equals( ::haxe::crypto::Adler32 a){
            	HX_STACKFRAME(&_hx_pos_9a8f9ab533ed2fe7_53_equals)
...
HX_DEFINE_DYNAMIC_FUNC1(Adler32_obj,equals,return )
 ...
 ::haxe::crypto::Adler32 Adler32_obj::read( ::haxe::io::Input i){
            	HX_GC_STACKFRAME(&_hx_pos_9a8f9ab533ed2fe7_60_read)
