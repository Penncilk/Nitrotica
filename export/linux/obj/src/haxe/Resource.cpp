...
HX_LOCAL_STACK_FRAME(_hx_pos_dbacd23b0487c9ff_35_getBytes,"haxe.Resource","getBytes",0x9bc1712d,"haxe.Resource.getBytes","/home/judeu/haxe/versions/4.1.5/std/cpp/_std/haxe/Resource.hx",35,0xc1df67f7)
namespace haxe{
...
bool Resource_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::io::Bytes Resource_obj::getBytes(::String name){
            	HX_STACKFRAME(&_hx_pos_dbacd23b0487c9ff_35_getBytes)
