...
HX_LOCAL_STACK_FRAME(_hx_pos_d959c7ee4bd35a89_47_writeByte,"haxe.io.Output","writeByte",0xb4fe513a,"haxe.io.Output.writeByte","/home/judeu/haxe/versions/4.1.5/std/haxe/io/Output.hx",47,0x2941de8e)
HX_LOCAL_STACK_FRAME(_hx_pos_d959c7ee4bd35a89_57_writeBytes,"haxe.io.Output","writeBytes",0xa988c1f9,"haxe.io.Output.writeBytes","/home/judeu/haxe/versions/4.1.5/std/haxe/io/Output.hx",57,0x2941de8e)
HX_LOCAL_STACK_FRAME(_hx_pos_d959c7ee4bd35a89_92_close,"haxe.io.Output","close",0xe726bfeb,"haxe.io.Output.close","/home/judeu/haxe/versions/4.1.5/std/haxe/io/Output.hx",92,0x2941de8e)
HX_LOCAL_STACK_FRAME(_hx_pos_d959c7ee4bd35a89_121_writeFullBytes,"haxe.io.Output","writeFullBytes",0xc2c420ea,"haxe.io.Output.writeFullBytes","/home/judeu/haxe/versions/4.1.5/std/haxe/io/Output.hx",121,0x2941de8e)
HX_LOCAL_STACK_FRAME(_hx_pos_d959c7ee4bd35a89_278_writeString,"haxe.io.Output","writeString",0x97e1cb83,"haxe.io.Output.writeString","/home/judeu/haxe/versions/4.1.5/std/haxe/io/Output.hx",278,0x2941de8e)
namespace haxe{
namespace io{
...
void Output_obj::writeByte(int c){
            	HX_STACKFRAME(&_hx_pos_d959c7ee4bd35a89_47_writeByte)
...
int Output_obj::writeBytes( ::haxe::io::Bytes s,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_d959c7ee4bd35a89_57_writeBytes)
...
void Output_obj::close(){
            	HX_STACKFRAME(&_hx_pos_d959c7ee4bd35a89_92_close)
            	}
...
void Output_obj::writeFullBytes( ::haxe::io::Bytes s,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_d959c7ee4bd35a89_121_writeFullBytes)
...
void Output_obj::writeString(::String s, ::haxe::io::Encoding encoding){
            	HX_STACKFRAME(&_hx_pos_d959c7ee4bd35a89_278_writeString)
