...
HX_DEFINE_STACK_FRAME(_hx_pos_4a8bf813a307ff72_37_new,"haxe.ds.GenericCell","new",0x14fd4914,"haxe.ds.GenericCell.new","/home/judeu/haxe/versions/4.1.5/std/haxe/ds/GenericStack.hx",37,0xc42aa247)
namespace haxe{
namespace ds{

void GenericCell_obj::__construct( ::Dynamic elt, ::haxe::ds::GenericCell next){
            	HX_STACKFRAME(&_hx_pos_4a8bf813a307ff72_37_new)
