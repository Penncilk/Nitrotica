...
HX_DEFINE_STACK_FRAME(_hx_pos_47f0a67fc3d5a02a_75_new,"haxe.xml.XmlParserException","new",0xcd6fdfea,"haxe.xml.XmlParserException.new","/home/judeu/haxe/versions/4.1.5/std/haxe/xml/Parser.hx",75,0x836f3d6d)
HX_LOCAL_STACK_FRAME(_hx_pos_47f0a67fc3d5a02a_95_toString,"haxe.xml.XmlParserException","toString",0xed7c2ce2,"haxe.xml.XmlParserException.toString","/home/judeu/haxe/versions/4.1.5/std/haxe/xml/Parser.hx",95,0x836f3d6d)
namespace haxe{
namespace xml{

void XmlParserException_obj::__construct(::String message,::String xml,int position){
            	HX_STACKFRAME(&_hx_pos_47f0a67fc3d5a02a_75_new)
...
::String XmlParserException_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_47f0a67fc3d5a02a_95_toString)
