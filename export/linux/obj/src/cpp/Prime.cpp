...
HX_LOCAL_STACK_FRAME(_hx_pos_ce16421e3f797ccf_34__loadPrime,"cpp.Prime","_loadPrime",0xdd360794,"cpp.Prime._loadPrime","/home/judeu/haxe/versions/4.1.5/std/cpp/Prime.hx",34,0x56c4ec1a)
namespace cpp{
...
bool Prime_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Prime_obj::_loadPrime(::String lib,::String prim,::String signature,::hx::Null< bool >  __o_quietFail){
            	...
            	HX_STACKFRAME(&_hx_pos_ce16421e3f797ccf_34__loadPrime)
