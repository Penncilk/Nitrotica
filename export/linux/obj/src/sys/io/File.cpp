...
HX_LOCAL_STACK_FRAME(_hx_pos_1388adeb74e930ce_30_getContent,"sys.io.File","getContent",0xb28b4a0e,"sys.io.File.getContent","/home/judeu/haxe/versions/4.1.5/std/cpp/_std/sys/io/File.hx",30,0x2baf884b)
HX_LOCAL_STACK_FRAME(_hx_pos_1388adeb74e930ce_51_read,"sys.io.File","read",0x203d07e1,"sys.io.File.read","/home/judeu/haxe/versions/4.1.5/std/cpp/_std/sys/io/File.hx",51,0x2baf884b)
HX_LOCAL_STACK_FRAME(_hx_pos_1388adeb74e930ce_55_write,"sys.io.File","write",0xfec8a9f4,"sys.io.File.write","/home/judeu/haxe/versions/4.1.5/std/cpp/_std/sys/io/File.hx",55,0x2baf884b)
namespace sys{
namespace io{
...
::String File_obj::getContent(::String path){
            	HX_STACKFRAME(&_hx_pos_1388adeb74e930ce_30_getContent)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(File_obj,getContent,return )
 ...
 ::sys::io::FileInput File_obj::read(::String path,::hx::Null< bool >  __o_binary){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_1388adeb74e930ce_51_read)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(File_obj,read,return )
 ...
 ::sys::io::FileOutput File_obj::write(::String path,::hx::Null< bool >  __o_binary){
            		bool binary = __o_binary.Default(true);
            	HX_GC_STACKFRAME(&_hx_pos_1388adeb74e930ce_55_write)
